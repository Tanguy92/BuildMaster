...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="View/Template/cssAllV2Message.css">
...
<body>
    ...
    <header class="topnav">
        <nav><a href="index.php?page=acceuilClient">
            <img class="logo" src="/BuildMaster/View/Image/Logo.png"></a>
            <ul>
